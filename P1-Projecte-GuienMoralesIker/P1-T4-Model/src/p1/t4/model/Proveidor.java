...
public class Proveidor {
	...
	private String pvCif;
	private int pvCodi;
	private String pvCodiMunicipi;
	private String pvCodiProvincia;
    ...
    public int getPvCodi() {
        return pvCodi;
    }

    public void setPvCodi(int pvCodi) {
        this.pvCodi = pvCodi;
    }

    public String getPvCodiMunicipi() {
        return pvCodiMunicipi;
    }

    public void setPvCodiMunicipi(String pvCodiMunicipi) {
        this.pvCodiMunicipi = pvCodiMunicipi;
    }

    public String getPvCodiProvincia() {
        return pvCodiProvincia;
    }

    public void setPvCodiProvincia(String pvCodiProvincia) {
        this.pvCodiProvincia = pvCodiProvincia;
    }
